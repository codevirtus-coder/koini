package com.koini.api.controller.client;
...
public class ClientController {
  ...
  @Operation(summary = "Transfer credits", description = "Transfers credits to another client")
  ...
  @Operation(summary = "Profile", description = "Returns client profile")
  @GetMapping("/profile")
  ...
  @Operation(summary = "Update profile", description = "Updates client profile")
  @PutMapping("/profile")
