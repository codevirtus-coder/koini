...
public class ConductorController {
  ...
  @Operation(summary = "Redeem payment code", description = "Redeems passenger payment code")
  ...
  @Operation(summary = "Create payment request", description = "Creates a payment request")
  ...
  @Operation(summary = "Request status", description = "Polls payment request status")
  ...
  @Operation(summary = "Shift report", description = "Returns today's earnings")
  ...
  @Operation(summary = "Routes", description = "Returns available routes")
  @GetMapping("/routes")
  ...
  @Operation(summary = "Dashboard summary", description = "One-call merchant dashboard summary (legacy alias)")
  ...
  @Operation(summary = "List payment requests", description = "Lists merchant payment requests (legacy alias)")
  ...
  @Operation(summary = "Get payment request", description = "Returns a payment request (legacy alias)")
  ...
  @Operation(summary = "Cancel payment request", description = "Cancels a payment request (legacy alias)")
  ...
  @Operation(summary = "Transaction receipt", description = "Returns a JSON receipt for a transaction (legacy alias)")
